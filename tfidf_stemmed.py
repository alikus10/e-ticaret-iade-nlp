...
tfidf_stem = pd.read_csv("output/tfidf_stemmed.csv")
texts = pd.read_csv("output/stemmed_sentences.csv")["stemmed_text"]

# --- 2. Adım: Giriş metnini belirle ---
query_text = "chang mind"
...
if len(query_indices) == 0:
    ...
    query_vec = tfidf_stem.iloc[query_index].values.reshape(1, -1)

    # --- 3. Adım: Tüm benzerlikleri hesapla ---
    similarities = cosine_similarity(query_vec, tfidf_stem.values).flatten()
